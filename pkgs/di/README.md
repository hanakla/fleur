# 🌼 @fleur/di 💉 [![npm version](https://badge.fury.io/js/%40fleur%2Fdi.svg)](https://www.npmjs.com/package/@fleur/di) [![travis](https://travis-ci.org/fleur-js/fleur.svg?branch=master)](https://travis-ci.org/fleur-js/fleur)
