...
export function actions<T extends { [key: string]: ActionIdentifier<any> }>(namePrefix: string, actions: T): T {
    Object.keys(actions).forEach(key => {
        Object.defineProperty(actions[key], 'name', { value: `${namePrefix}/${key}` })
    })
